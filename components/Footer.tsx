    ...
    <footer className="bg-secondary text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <address className="not-italic">
              <p className="mb-2">123 Restaurant Caddesi</p>
          ...
          <div>
            <h3 className="text-xl font-playfair mb-4">Çalışma Saatleri</h3>
            <ul>
              <li className="mb-2">Pazartesi - Cuma: 11:00 - 23:00</li>
              <li className="mb-2">Cumartesi: 10:00 - 23:00</li>
              <li>Pazar: 10:00 - 22:00</li>
            </ul>
          </div>
          <div>
            <h3 className="text-xl font-playfair mb-4">Bizi Takip Edin</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Restaurant. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  )
